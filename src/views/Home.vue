<template>
  <article>
    <section>
      ...
      <p>
        Connaissez-vous vraiment les dangers d'internet auxquels vous êtes exposés chaque jour ? <br>
  ...
  <article>
    <section>
      ...
      <p>
        Découvrez nos quiz plus approfondit vous permettant de tester vos connaissances et apprendre de nouvelles techniques de protection :
      </p>
    </section>
  </article>
</template>
